  ...
  function loadDashboardData() {
    ...
    .then(data => {
      ...
      document.getElementById('total-orders').textContent = data.orderCount || 0;
      document.getElementById('total-revenue').textContent = `$${(data.totalRevenue || 0).toFixed(2)}`;
      document.getElementById('total-products').textContent = data.productCount || 0;
  ...
  function setupProductActionButtons() {
    ...
    document.querySelectorAll('.delete-product').forEach(button => {
      button.addEventListener('click', function(e) {
        ...
        confirmDialog.innerHTML = `
          <div class="confirm-content">
            ...
            <div class="confirm-body">
              ...
              <p class="warning-text">This action cannot be undone and will remove all product data including images and reviews.</p>
            </div>
        ...
        // Add styles for the dialog if not already added
        ...
        confirmDialog.querySelector('.btn-delete').addEventListener('click', function() {
          document.body.removeChild(confirmDialog);
  ...
  function saveProduct() {
    ...
    const productData = {
      ...
      countInStock: parseInt(document.getElementById('product-stock').value) || 0, // Ensure 0 is used if parsing fails
  ...
  if (ordersTableBody) {
    ...
    .then(data => {
      ...
      document.querySelectorAll('.delete-order-btn').forEach(button => {
        button.addEventListener('click', function() {
          const orderId = this.getAttribute('data-id');
          const orderNumber = this.closest('tr').querySelector('td:nth-child(1)').textContent;
          ...
          confirmDialog.innerHTML = `
            <div class="confirm-content">
              ...
              <div class="confirm-body">
                <p>Are you sure you want to delete order <strong>#${orderNumber}</strong>?</p>
                <p class="warning-text">This action cannot be undone and will remove all order data.</p>
              </div>
              <div class="confirm-footer">
                <button class="btn-cancel">Cancel</button>
